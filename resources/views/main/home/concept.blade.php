 ...
 top:1px;
        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="row">
                    ...
                    <div class="col-4">
                        <a class="btn btn-info p-2 mb-4" href="#" data-bs-toggle="modal" data-bs-target="#sharedModal" data-modal-title="Knowledge Acquisition" data-modal-body="Content related to Knowledge Acquisition.">Knowledge Acquisition</a>
                    </div>
                    <div class="col-4">
                        <div class="concept-flex-center"></div>
                    </div>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="concept-flex-center">
                            <a class="btn btn-info p-2" href="#" data-bs-toggle="modal" data-bs-target="#sharedModal" data-modal-title="Knowledge Use" data-modal-body="Content related to Knowledge Use.">Knowledge Use</a>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="concept-flex-center">
                    ...
                    <div class="col-4">
                        <div class="concept-flex-center">
                            <a class="btn btn-info p-2" href="#" data-bs-toggle="modal" data-bs-target="#sharedModal" data-modal-title="Knowledge Storage" data-modal-body="Content related to Knowledge Storage.">Knowledge Storage</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="concept-flex-center">
                            <a class="btn btn-info p-2 mt-4" href="#" data-bs-toggle="modal" data-bs-target="#sharedModal" data-modal-title="Knowledge Distribution" data-modal-body="Content related to Knowledge Distribution.">Knowledge Distribution</a>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="concept-flex-center"></div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    <img class="img-fluid" src="{{ asset('assets/img/c2c.JPG') }}"
