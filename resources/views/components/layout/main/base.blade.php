    ...
    <footer>
        <div class="pt-3 mb-0 pb-0">
            <p class="text-center m-0 p-0">
                All Rights Reserved  &copy; {{date('Y')}} <a target="_bank" href="https://sarganga.com/">sarganga.com</a>
            </p>
        </div>        
    </footer>
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const modalId = window.location.hash; // e.g., "#exampleModal"
            
            if (modalId) {
                // Ensure the element with this ID exists and is a modal
